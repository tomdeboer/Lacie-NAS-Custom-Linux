...
qemu-debootstrap --arch=armel --variant=minbase --verbose --foreign --include=exfat-fuse,rsync,nano,ntpdate,wget,net-tools,iputils-ping jessie /files/rootfs "http://ftp.nl.debian.org/debian/"